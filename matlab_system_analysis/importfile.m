...
gdLog = table(dataArray{1:end-1}, 'VariableNames', {
    ...
    'gimbalRPYCmd_0','gimbalRPYCmd_1','gimbalRPYCmd_2','gimbalRPY_0', 'gimbalRPY_1', 'gimbalRPY_2', ... // 20+15+24+15+23
    'windStatus', 'windSpeed', 'windAngle', 'windQueryTime', 'windResponseTime', ...
    'acousticTemp', 'tempQueryTime', 'tempResponseTime', ...
    'accBody_0', 'accBody_1', 'accBody_2', ... // 20+15+24+15+23+11
    ...
    'GuideModeLongPidErr', 'GuideModeLongPidRate', 'GuideModeLongPidIgain', ... % 20+15+24+15+23+11+18
    'pqr_0', 'pqr_1', 'pqr_2', ... 
    'rpdCmd_0', 'rpdCmd_1', 'rpdCmd_2', ... 
    'velCmdNav_0', 'velCmdNav_1', 'velCmdNav_2', ...
    'posCmdNed_0', 'posCmdNed_1', 'posCmdNed_2', ...
    'missionType', 'jobType', ...
    'bladeTravelDistance', 'trajTimeCur', 'trajTimeMax'}); % 20+15+24+15+23+11+18+17 = 143
